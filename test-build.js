...
try {
  ...
  const requiredDeps = ['morgan', 'express', 'axios', 'ini', '@modelcontextprotocol/sdk'];
  const requiredDevDeps = ['typescript', '@types/morgan', '@types/express', '@types/ini'];
...
try {
  ...
  if (serverContent.includes('HTTP Request Logging: Morgan middleware enabled')) {
