...
async function testMcpServer() {
  ...
  try {
    ...
    const transport = new StdioClientTransport({
      ...
      env: {
        ...
        SUPERVISORD_EXECUTABLE_PATH:
          "E:\\迅雷下载\\supervisord_0.7.3_Windows_64-bit\\supervisord_0.7.3_Windows_64-bit\\supervisord.exe",
        CONFIG_FILE_PATH:
          "E:\\projects\\refactor-the-project\\supervisord.conf",
        MCP_PORT: "30000",
      },
    });
    ...
    try {
      ...
      console.log(
        "✅ list_programs result:",
        JSON.stringify(listResult.content, null, 2),
      );
    } catch (error) {
    ...
    try {
      ...
      console.log(
        "✅ get_supervisor_info result:",
        JSON.stringify(infoResult.content, null, 2),
      );
    } catch (error) {
